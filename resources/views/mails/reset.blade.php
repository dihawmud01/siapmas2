    ...
    <style type="text/css">
        ...
        * {
        ...
        @media screen and (max-width: 600px) {
            ...
            .pr-4:not(table), .pr-4:not(.btn) > tbody > tr > td, .pr-4.btn td a, .px-4:not(table), .px-4:not(.btn) > tbody > tr > td, .px-4.btn td a {
                padding-right: 16px !important
            }

            .pl-4:not(table), .pl-4:not(.btn) > tbody > tr > td, .pl-4.btn td a, .px-4:not(table), .px-4:not(.btn) > tbody > tr > td, .px-4.btn td a {
                padding-left: 16px !important
            }

            .pr-6:not(table), .pr-6:not(.btn) > tbody > tr > td, .pr-6.btn td a, .px-6:not(table), .px-6:not(.btn) > tbody > tr > td, .px-6.btn td a {
                padding-right: 24px !important
            }

            .pl-6:not(table), .pl-6:not(.btn) > tbody > tr > td, .pl-6.btn td a, .px-6:not(table), .px-6:not(.btn) > tbody > tr > td, .px-6.btn td a {
                padding-left: 24px !important
            }

            .pt-8:not(table), .pt-8:not(.btn) > tbody > tr > td, .pt-8.btn td a, .py-8:not(table), .py-8:not(.btn) > tbody > tr > td, .py-8.btn td a {
                padding-top: 32px !important
            }

            .pb-8:not(table), .pb-8:not(.btn) > tbody > tr > td, .pb-8.btn td a, .py-8:not(table), .py-8:not(.btn) > tbody > tr > td, .py-8.btn td a {
                                    ...
                                    <table align="center" role="presentation" border="0" cellpadding="0" cellspacing="0"
                                        ...
                                        <tr>
                                            <td style="line-height: 24px; font-size: 16px; margin: 0;" align="left">
                                                ...
                                                <img class="w-16" src="{{ asset('storage/images/logokomi.png') }}"
                                                ...
                                                <div class="space-y-4">
                                                    <h1 class="text-4xl fw-800"
                                                        ...
                                                        align="left">PMII Komisariat Uninus</h1>
                                                ...
                                                <table class="card rounded-3xl px-4 py-8 p-lg-10" role="presentation"
                                                    ...
                                                    <tr>
                                                        <td style="line-height: 24px; font-size: 16px; width: 100%; border-radius: 24px; margin: 0; padding: 40px;"
                                                            ...
                                                            <h3 class="text-center mb-2"
                                                                ...
                                                                align="center">Salam Pergerakan</h3>
                                                            <p class="text-center text-muted mb-2"
                                                               style="line-height: 24px; font-size: 16px; color: #718096; width: 100%; margin: 0;"
                                                               align="center">You are receiving this email because we
                                                                ...
                                                                <tr>
                                                                    <td style="line-height: 24px; font-size: 16px; border-radius: 9999px; width: 192px; margin: 0;"
                                                                        ...
                                                                        <a href="https://app.bootstrapemail.com/templates"
                                                                           style="color: #ffffff; font-size: 16px; font-family: Helvetica, Arial, sans-serif; text-decoration: none; border-radius: 9999px; line-height: 20px; display: block; font-weight: normal; background-color: #dc3545; padding: 8px 24px; border: 1px solid #dc3545;">Reset
                                                                            Password</a>
                                                                    </td>
                                                                </tr>
                                                                </tbody>
                                                            ...
                                                            <p style="line-height: 24px; font-size: 16px; width: 100%; margin: 0;"
                                                               align="left">This password reset link will expire in 60
                                                                minutes.
                                                            ...
                                                            <a href="https://bootstrapemail.com"
                                                               style="color: #0d6efd;"><span class="__cf_email__"
                                                                                             data-cfemail="baf2d3caf9d5c8cafadfc2dbd7cad6df94d9d5d7">[email&#160;protected]</span></a>.</p>
